...
public class Installer extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        stage.setTitle("Installing the YouTube Client...");

        stage.setOnCloseRequest(event -> {
            Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
            alert.setTitle("Warung!");
            alert.setHeaderText("Es sieht so aus, als würdest du das Fenster schließen wollen...");
            alert.setContentText("Wenn du auf \"Ok\" klickst, wird die Installation des YouTube Client abgebochen und das Fenster schließt sich. Wenn du dies nicht beabsichtigt hast, klick auf \"Abbrechen\".");
        ...
        Thread t2 = new Thread(() -> {
            ...
            Platform.runLater(() -> {
                ...
                alert.setHeaderText("Der YouTube Client wurde erfolgreich installiert.");
                alert.setContentText("Du kannst nu den Offiziellen Minecraft Launcher öffnen und unseren Client spielen, Viel Spaß!\n~ CraftsBlock Development");
